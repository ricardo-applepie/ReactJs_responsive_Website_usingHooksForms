...
function Login() {
  ...
  function loginUser() {
    ...
    axios
      .post('https://dev.helppr.ai/user/login/', {
            ...
            <div>
              <div className="login-welcome-back">
                ...
                <p>
                  ...
                  <span>
                    <a href={formerPageUrls.accounts}>Sign Up</a>
                  </span>
                </p>
              </div>
                ...
                <form className="login__form">
                  <div>
                    ...
                    <div className="login__form_password">
                      <input
                        onChange={() => TogglePasswordDisplay('password')}
                    ...
                    <Button buttonStyle="login-form">Login</Button>
                    <div className="forgot-password">
                      <p>
                        Forgot your password{' '}
                        <span>
                          <Link to={reactPageUrls.reset}>Reset it</Link>{' '}
                        </span>
                      </p>
                    </div>
                  </div>
