      ...
      <div class="container ">
        <div class="row align-items-start connect-data-smarter">
          <div class="col ">
            <div className="connect-data-smarter__text">
              ...
              <p className="connect-data-smarter-p">
                Connect your data across multiple platform to Tableau, Google
                sheets, Excel and More{' '}
              </p>
        ...
        <div ref={myRef} className="what-can-you-do-with-metrics">
          <div className="what-can-you-do-with-metrics_title-wrapper">
            <h2 className="what-can-you-do-with-metrics_title">
              {' '}
              What You Can DO WIth 101Metrics
            </h2>
          </div>
          <div class="row align-items-start">
            <div class=" col-md-3 col-xs-12">
              ...
              <h2 className="what-can-you-do-with-metrics_sub-title">
                {' '}
                CONNECT <br />
                YOUR DATA SOURCE{' '}
              </h2>
              <div>
                <p>No-Code Data Connection to Your Preferred Channel.</p>
              </div>
            </div>
            <div class="col-md-3 col-xs-12 ">
              <div>
              ...
              <div>
                <p>
                  Sync all of your channels to easily manage orders in one
                  place.
                </p>
              </div>
            </div>
            ...
            <div class="col-md-3 col-xs-12 ">
              ...
              <div>
                <p>
                  Generate only relevant data with embedded filters at source.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="row align-self-start all-the-data-sources">
          ...
          <div class="col all-the-data-sources-text ">
            ...
            <p className="all-the-data-sources__explanation">
              Don’t let Integration efforts impede your research. We partner
              with over 50+ platforms and so that you can get started
        ...
        <div class="row align-self-start data_where-you-need-it">
          <div class="col   data_where-you-need-it-text ">
            ...
            <p>
              Fetch data automatically from your preferred data source so you
              don’t have to copy/paste data for your app reports, analysis and
              dashboards ever again.
            </p>
          </div>
