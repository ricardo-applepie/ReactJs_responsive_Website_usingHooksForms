                                        ...
                                        <p className="emailValidator-error">{error} </p>
                                          ...
                                          <div className="update__input">
                                            <div className="login__form_password">
                                                <input name="password" onBlur={(e) => handlepasswordChange(e)} type={passwordDisplay} className="login__form-input" placeholder="Password" />
                                                <img onMouseDown={(e) => handlemousedown(e)} onMouseUp={() => TogglePasswordDisplay("password")} src={passwordEyeDisplay} alt="" />

                                              </div>
                                          
                                            <div className="login__form_password">
                                                <input name="confirmPassword" onBlur={(e) => handlepasswordConfirmChange(e)} type={passwordConfrimDisplay} className="login__form-input" placeholder="Confrim Password" />
                                            ...
                                            <p className="update__input-text">The password should be 8 characters and have 1 uppercase, 1 lowercase and 1 numerical character</p>
