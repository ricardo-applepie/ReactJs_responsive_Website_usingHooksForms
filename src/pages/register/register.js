...
function Register (){
    ...
    const [passwordConfrimDisplay, TogglePasswordConfirmDisplay] = useState("password"); 
    ...
    function handlepasswordChange(e) {
        ...
        let hasPasswordUpperLowerAndNumber = checkUpperLowerCaseAndNumber(e.target.value)
        ...
        if (!hasPasswordUpperLowerAndNumber && inputVal1.length < 8) {
            ...
            setError("Your password must consist of  1 uppercase, 1 lowercase and 1 numerical character ")
        ...
        <div className="register display-flex container ">
            <div className="register__form">
                ...
                <div className="">
                        ...
                        <form onSubmit={(e) => onFormSumit(e)} className="">
                            <div className="">
                                ...
                                <div className="register__firstAndLastname display-flex-justify">
                                    ...
                                    <input className="work-mail login__form-input"  onBlur={(e) => validateEmail(e)}/>
                                    <label>Password</label>
                                    <p className="emailValidator-error">{error}</p>

                                <div className="login__form_password">
                                    <input className="full-name login__form-input" onBlur={(e) => handlepasswordChange(e)} name="password" type={passwordDisplay}/>

                                    <img onMouseDown={(e) => handlemousedown(e)} onMouseUp={() => TogglePasswordDisplay("password")} src={passwordEyeDisplay} alt="" />
                                </div>
                                    <label>Confirm Password</label>
                                <div className="login__form_password">
                                    <input className="full-name login__form-input" onBlur={(e) => handlepasswordConfirmChange(e)} type={passwordConfrimDisplay}  />

                                    <img onMouseDown={(e) => handlemousedownConfrmPassword(e)} onMouseUp={() => TogglePasswordConfirmDisplay("password")}  src={passwordEyeDisplay} alt="" />
                                </div>
                                <p className="emailValidator-error">{termsAndConditionError}</p>

                                <div className="remember-me display-flex">
                                    <input onChange={(e)=>handleChecked(e)} type="checkbox" checked={isChecked} className="login__form-checkbox" />
                                    <p>I accept<a href={formerPageUrls.terms}> <span>Terms and Conditions</span></a></p>
                                </div>
                        ...
                        <p className="already__have__and__account">Already have an 101metrics account? <a href={formerPageUrls.signin}><span>Sign In </span></a></p>
                </div>
                </div>
            </div>
