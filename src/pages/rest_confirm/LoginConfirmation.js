          ...
          <div className="login-confirmation">
            ...
            <div className="reset-confirm-text-wrapper">
              <p className="reset-confirm-text">
                We have sent an email to the provided account email address if
                an account exists. Please check your inbox and follow the
                instructions given.
                <br />
                <br />
                <br />
              ...
              <p className="reset-confirm-receive-email">
                If you do not receive an email, please try again or contact{' '}
                <span>support@101metrics.com</span> for help.
              </p>
            </div>

            <div className="login-confirm-btn-wrapper">
              <Link to="/">
                <Button buttonStyle="login-confirm-btn">BACK TO METRICS</Button>
              </Link>
            </div>
          </div>
        </div>
